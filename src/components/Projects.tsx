...
const PROJECTS: Project[] = [
  ...
  {
    id: 4,
    title: 'Cost Manager Web Application',
    description:
      'A React-based Cost Manager application featuring a custom IndexedDB-style data layer for persistent local storage and real-time currency conversion using a custom REST API.',
    technologies: ['JS', 'React', 'HTML', 'CSS'],
    githubUrl: 'https://github.com/Galaviv15/cost-manager-app-fed',
